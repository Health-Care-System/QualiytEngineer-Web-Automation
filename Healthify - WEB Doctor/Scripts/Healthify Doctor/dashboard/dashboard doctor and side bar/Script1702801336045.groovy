...
WebUI.click(findTestObject('Object Repository/Page_Healthify Doctor/div_Chat Pasien'))
...
WebUI.click(findTestObject('Object Repository/Page_Healthify Doctor/div_Feedback'))

WebUI.click(findTestObject('Object Repository/Page_Healthify Doctor/div_Dashboard'))
