...
WebUI.click(findTestObject('Object Repository/Page_Healthify Admin/btn_Logout'))

WebUI.click(findTestObject('Object Repository/Page_Healthify Admin/button_Ya'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Healthify Admin/h3_Portal Admin'))
