...
WebUI.setText(findTestObject('Object Login/input_Email_email'), 'salah@mail.com')
...
WebUI.verifyElementNotVisible(findTestObject('Object Repository/Page_Healthify Admin/p_Email tidak terdaftar'))
